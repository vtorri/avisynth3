...
#ifndef __AVS_VFW_AVISTREAMINFO_AUDIO_H__
#define __AVS_VFW_AVISTREAMINFO_AUDIO_H__
...
//
//
class Audio : public AviStreamInfo
{
...
#endif //__AVS_VFW_AVISTREAMINFO_AUDIO_H__
