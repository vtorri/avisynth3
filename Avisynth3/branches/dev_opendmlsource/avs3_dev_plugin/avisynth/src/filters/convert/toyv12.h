...
#ifndef __AVS_FILTERS_CONVERT_TOYV12_H__
#define __AVS_FILTERS_CONVERT_TOYV12_H__
...
//  convert::ToYV12
//
//  converts a clip to YV12
//
class ToYV12 : public Convert
{

public: //structors

  ToYV12(PClip const& child);
...
#endif //__AVS_FILTERS_CONVERT_TOYV12_H__
