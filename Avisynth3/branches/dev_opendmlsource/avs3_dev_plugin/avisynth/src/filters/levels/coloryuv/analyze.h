...
#ifndef __AVS_FILTERS_COLORYUV_ANALYZE_H__
#define __AVS_FILTERS_COLORYUV_ANALYZE_H__
...
class Analyze : public ColorYUV
{

public:  //structors

  Analyze(PClip const& child)
    : ColorYUV( child ) { }
...
#endif //__AVS_FILTERS_COLORYUV_ANALYZE_H__
