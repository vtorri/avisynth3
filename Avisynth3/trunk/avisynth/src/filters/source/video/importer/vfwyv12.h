...
#ifndef __AVS_FILTERS_SOURCE_VIDEO_IMPORTER_VFWYV12_H__
#define __AVS_FILTERS_SOURCE_VIDEO_IMPORTER_VFWYV12_H__
...
#endif //__AVS_FILTERS_SOURCE_VIDEO_IMPORTER_VFWYV12_H__
