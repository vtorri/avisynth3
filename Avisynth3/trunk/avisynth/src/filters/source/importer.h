...
#ifndef __AVS_FILTERS_SOURCE_IMPORTER_H__
#define __AVS_FILTERS_SOURCE_IMPORTER_H__

//avisynth includes
#include "../../define.h"                   //for AVS_NOVTABLE
#include "../../core/forward.h"             //for PColorSpace, PVideoFrame, Dimension, owned_block template

//boost include
#include <boost/shared_ptr.hpp>             //so PColorSpace, PVideoFrame
...
#endif //__AVS_FILTERS_SOURCE_IMPORTER_H__
