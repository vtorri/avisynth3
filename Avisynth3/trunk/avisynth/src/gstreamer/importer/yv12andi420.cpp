...
PColorSpace YV12AndI420::GetColorSpace() const
{
  return ColorSpace::yv12();
}


PVideoFrame YV12AndI420::CreateFrame(Dimension const& dim, owned_block<1> const& block) const
{
