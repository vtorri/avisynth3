...
#ifndef __AVS_EXCEPTION_GSTREAMER_H__
#define __AVS_EXCEPTION_GSTREAMER_H__
...
//
class Gstreamer : public Exception
{
...
public:  //structors
  ...
  Gstreamer( std::string const& msg)
    : msg_( msg ) { }
...
#endif //__AVS_EXCEPTION_GSTREAMER_H__
