...
#ifndef __AVS_SPLICE_H__
#define __AVS_SPLICE_H__
...
//
class Splice : public AbstractSplice
{  
...
public:  //constructors
  ...
  Splice(PClip first, PClip second)
...
private: 
  ...
  {
    return dynamic_cast<const Splice>(child);
  }

  virtual __int64 SamplesToSpliceFrom(const VideoInfo& vi) const
  {
    return vi.AudioSamplesFromFrames( vi.GetFrameCount() );
  }
