...
#ifndef __AVS_FILTERS_SPLICE_NOVIDEO_H__
#define __AVS_FILTERS_SPLICE_NOVIDEO_H__
...
//  splice::NoVideo
//
//  splice subclass for clips without video
//
class NoVideo : public Splice
{
...
public:  //structors
  ...
  NoVideo(CPVideoInfo const& vi, PEnvironment const& env)
    : Splice( vi, env ) { }
...
#endif //__AVS_FILTERS_SPLICE_NOVIDEO_H__
