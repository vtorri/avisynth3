...
#ifndef __AVS_VIDEOFRAME_CONCRETE_YV45_H__
#define __AVS_VIDEOFRAME_CONCRETE_YV45_H__
...
public:  //structors
  ...
  //normal constructor
  YV45(Dimension const& dim, FrameType type, PEnvironment env);
...
#endif //__AVS_VIDEOFRAME_CONCRETE_YV12_H__
