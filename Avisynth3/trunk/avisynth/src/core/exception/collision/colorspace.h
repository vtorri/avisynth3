...
#ifndef __AVS_EXCEPTION_COLLISION_COLORSPACE_H__
#define __AVS_EXCEPTION_COLLISION_COLORSPACE_H__
...
public:  //diagnostic message
  ...
  virtual char const * what() const throw() { return "ColorSpace Collision"; }
...
#endif //__AVS_EXCEPTION_COLLISION_COLORSPACE_H__
