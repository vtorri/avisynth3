...
#ifndef __AVS_COLORSPACE_CONCRETE_INTERNALCREATOR_H__
#define __AVS_COLORSPACE_CONCRETE_INTERNALCREATOR_H__
...
class InternalCreator
{
  ...
  typedef ColorSpace const * (* CreateMethod)();
...
#endif //__AVS_COLORSPACE_CONCRETE_INTERNALCREATOR_H__
