...
#ifndef __AVS_BLOCK_HOLDER_OWNEDBASE_H__
#define __AVS_BLOCK_HOLDER_OWNEDBASE_H__
...
public:  //structors
  ...
  virtual ~OwnedBase() { env_->MemoryFreed( size_ ); }
...
#endif //__AVS_BLOCK_HOLDER_OWNEDBASE_H__
