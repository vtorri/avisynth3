...
Function Combine::stackVertical( 'c', "StackVertical", "cc", adapt( &filters::stack::Vertical::Create ) );
Function Combine::stackHorizontal( 'c', "StackHorizontal", "cc", adapt( &filters::stack::Horizontal::Create ) );
