...
#ifndef __AVS_EXPORT_VFW_AVISTREAM_VIDEO_H__
#define __AVS_EXPORT_VFW_AVISTREAM_VIDEO_H__
...
private:  //AviStream interface
  ...
  virtual long FindKeySample(long n, bool previous);
...
#endif //__AVS_EXPORT_VFW_AVISTREAM_VIDEO_H__
