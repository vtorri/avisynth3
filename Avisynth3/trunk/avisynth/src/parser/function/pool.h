...
#ifndef __AVS_PARSER_FUNCTION_POOL_H__
#define __AVS_PARSER_FUNCTION_POOL_H__
...
class Pool
{
  ...
  typedef std::vector<linker::PFunction> FunctionVector;

  FunctionVector functionList_;
...
#endif //__AVS_PARSER_FUNCTION_POOL_H__
