...
#ifndef __AVS_FILTERS_CONVERT_TOYUY2_H__
#define __AVS_FILTERS_CONVERT_TOYUY2_H__
...
//  convert::ToYUY2
//
//  converts a clip to YUY2
//
class ToYUY2 : public Convert
{

public: //structors

  ToYUY2(PClip const& child);
...
#endif //__AVS_FILTERS_CONVERT_TOYUY2_H__
