...
#ifndef __AVS_TIMING_TIMERSTACK_H__
#define __AVS_TIMING_TIMERSTACK_H__
...
public:  //stack like push and pop methods
...
public:  //interrupt/restart methods

  void interrupt()
  {
    if ( ! stack_.empty() )
      stack_.top()->interrupt();
  }
...
#endif //__AVS_TIMING_TIMERSTACK_H__
