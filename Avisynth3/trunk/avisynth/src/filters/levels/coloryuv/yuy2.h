...
#ifndef __AVS_FILTERS_COLORYUV_YUY2_H__
#define __AVS_FILTERS_COLORYUV_YUY2_H__
...
//  coloryuv::YUY2
//
//  ColorYUV subclass dealing with the YUY2 color space
//
class YUY2 : public ColorYUV
{
...
#endif //__AVS_FILTERS_COLORYUV_YUY2_H__
