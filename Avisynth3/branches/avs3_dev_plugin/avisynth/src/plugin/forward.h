...
#ifndef __AVS_PLUGIN_FORWARD_H__
#define __AVS_PLUGIN_FORWARD_H__
...
//typedefs
typedef boost::shared_ptr<Handle const> PHandle;
typedef boost::shared_ptr<Linker const> PLinker;
typedef boost::shared_ptr<Plugin const> PPlugin;
typedef boost::shared_ptr<PluginDef const> PPluginDef;


} } //namespace avs::plugin

#endif //__AVS_PLUGIN_FORWARD_H__
