...
#ifndef __AVS_CACHINGCLIP_CONCRETE_H__
#define __AVS_CACHINGCLIP_CONCRETE_H__
...
//
//  implementation of the CachingClip interface
//
...
#endif //__AVS_CACHINGCLIP_CONCRETE_H__