...
#ifndef __AVS_COLORSPACE_CONCRETE_EXTERNALCREATOR_H__
#define __AVS_COLORSPACE_CONCRETE_EXTERNALCREATOR_H__
...
#endif //__AVS_COLORSPACE_CONCRETE_EXTERNALCREATOR_H__
