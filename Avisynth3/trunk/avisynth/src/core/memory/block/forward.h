...
#ifndef __AVS_MEMORY_BLOCK_FORWARD_H__
#define __AVS_MEMORY_BLOCK_FORWARD_H__

//boost forward declaration
namespace boost { template <typename T> class shared_ptr; }


namespace avs { namespace memory { namespace block {
...
} } } //namespace avs::memory::block

#endif //__AVS_MEMORY_BLOCK_FORWARD_H__
