...
#ifndef __AVS_GSTREAMER_AUDIOSTRUCTURE_H__
#define __AVS_GSTREAMER_AUDIOSTRUCTURE_H__
...
//
//
class AudioStructure : public Structure
{
...
#endif //__AVS_GSTREAMER_AUDIOSTRUCTURE_H__
