...
#ifndef __AVS_EXCEPTION_COLLISION_FRAMECOUNT_H__
#define __AVS_EXCEPTION_COLLISION_FRAMECOUNT_H__
...
public:  //diagnostic message
  ...
  virtual char const * what() const throw() { return "FrameCount Collision"; }
...
#endif //__AVS_EXCEPTION_COLLISION_FRAMECOUNT_H__
