...
#ifndef __AVS_EXCEPTION_COLLISION_DIMENSION_H__
...
//
class Dimension : public Exception
{
...
public:  //diagnostic message
  ...
  virtual char const * what() const throw() { return "Dimension Collision"; }
...
#endif //__AVS_EXCEPTION_COLLISION_DIMENSION_H__
