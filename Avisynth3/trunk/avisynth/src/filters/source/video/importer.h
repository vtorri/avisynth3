...
#ifndef __AVS_FILTERS_SOURCE_VIDEO_IMPORTER_H__
#define __AVS_FILTERS_SOURCE_VIDEO_IMPORTER_H__

//avisynth includes
#include "../../../define.h"                //for AVS_NOVTABLE
#include "../../../core/forward.h"          //for PColorSpace, CPVideoFrame, Dimension, owned_block template
...
public:  //Importer interface
  ...
  virtual CPVideoFrame CreateFrame(Dimension const& dim, owned_block<1> const& block) const = 0;
...
#endif //__AVS_FILTERS_SOURCE_VIDEO_IMPORTER_H__
